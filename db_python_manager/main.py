...
try:
    from db_python_manager.receiver import file_receiver
    from db_python_manager.db import db
    from db_python_manager.data_source.inserter import Inserter
    from db_python_manager.data_source.transformers import JSONDataSource
...
def db_process():
    ...
    try:
        data_source = JSONDataSource(config_path="db_python_manager/data_source/config.ini")
    except KeyError:
